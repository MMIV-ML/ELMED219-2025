...
|  [04-MNIST-Classifcation-with-CNN.ipynb]()  <br>MNIST classification using a convolutional neural network, CNN. Check the repo: [PyTorch-Lightning-MNIST-Classifier](https://github.com/sxg/PyTorch-Lightning-MNIST-Classifier)| [![Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MMIV-ML/ELMED219-2025/blob/main/Lab2-DL/notebooks/04-MNIST-Classifcation-with-CNN.ipynb)<br>
